...
class CadProdutoPage extends HTMLElement {
    connectedCallback() {
            ...
            <form id="form-produto">
                <ion-list>
                    ...
                    <ion-item>
                        ...
                        label="Valor Unitario" label-placement="floating" required>
                        </ion-input>
                    </ion-item>
                    <ion-item>
                ...
                <ion-button expand="block" color="danger" id="bnt-cancelar">
                Cancelar
                </ion-button>
                </div>
            </form>
        ...
        this.querySelector('#bnt-cancelar').addEventListener('click', 
